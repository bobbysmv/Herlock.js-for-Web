...
define([
    ...
    "./flash/internal/renderer/CSSRenderingSystem"
],function( Class, NJModule, window, Layer, Image, flash, geom, Rectangle, TouchEventInfo, CSSRenderingSystem ){
    ...
    var NJView = Class( NJModule, function( cls, parent ){
        ...
        cls.constructor = function( container, width, height ){
            ...
            CSSRenderingSystem.container = this._container = container;

            CSSRenderingSystem.width = this._width = width;
            CSSRenderingSystem.height = this._height = height;
