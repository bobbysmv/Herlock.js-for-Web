...
(function(){
    ...
    CustomClassDefinition.prototype.inherit = function( parentClass ) {
        if( parentClass._class_id && ClassList.getById( parentClass._class_id ) )
            this.parent = ClassList.getById( parentClass._class_id );
        else
    ...
    CustomClassDefinition.prototype.fix = function () {
        ...
        inheritList.forEach(function( definition ){ implementedIdList.push( definition._class_id ); });

        // instanceOf
        function isInstanceOf( constructorOrClass ) {
            if( ( "_class_id" in constructorOrClass ) !== true ) throw new Error( "ERROR: "+this + ".isInstanceOf( " +constructorOrClass+ " );");
            return implementedIdList.indexOf( constructorOrClass._class_id ) !== -1;
        };
...
//                this.isInstanceOf = isInstanceOf;
            ...
            cnst._class_id = definition._class_id;
            return cnst;
//        };
//        constructor._class_id = definition._class_id;
