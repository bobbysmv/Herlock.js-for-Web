__req.define([
    "lib/Class",
    "src/view/gl/IRenderable",
    "src/view/gl/Viewport",
    "./Sprite",
    "../internal/renderer/RenderingNode",
    "../internal/renderer/RenderingSystem",
    "src/view/touch/TouchEventInfo",
    "../events/InteractiveObjectTouchEvent"
],function( Class, IRenderable, Viewport, Sprite, RenderingNode, RenderingSystem, TouchEventInfo, InteractiveObjectTouchEvent ){
